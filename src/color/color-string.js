...
cs.to.hsl = function () {
	...
	return hsla.length < 4
		? 'hsl(' + hsla[0] + ', ' + hsla[1] + '%, ' + hsla[2] + '%)'
		: 'hsla(' + hsla[0] + ', ' + hsla[1] + '%, ' + hsla[2] + '%, ' + hsla[3] + ')';
};

cs.to.hsv = function () {
	var hsva = swizzle(arguments);
	return hsva.length < 4
